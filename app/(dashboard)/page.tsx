  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500">{t('dashboard', translations.dashboard)}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">{t('totalProducts', translations.totalProducts)}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">{t('activeProducts', translations.activeProducts)}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">{t('pendingOrders', translations.pendingOrders)}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">{t('totalSales', translations.totalSales)}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">{t('recentOrders', translations.recentOrders)}</h2>
          ...
          <div className="p-6">
            {recentOrders.length === 0 ? (
              <p className="text-gray-500 text-center py-8">{t('noOrders', translations.noOrders)}</p>
            ) : (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="p-6 border-b border-gray-100">
            <h2 className="text-lg font-semibold text-gray-900">{t('quickActions', translations.quickActions)}</h2>
          </div>
          <div className="p-6 space-y-3">
            ...
            >
              ...
              <span className="font-medium text-primary-700">{t('addProduct', translations.addProduct)}</span>
            </a>
            ...
            >
              ...
              <span className="font-medium text-blue-700">{t('viewOrders', translations.viewOrders)}</span>
            </a>
            ...
            >
              ...
              <span className="font-medium text-gray-700">{t('updateProfile', translations.updateProfile)}</span>
            </a>
          </div>
        </div>
      </div>
