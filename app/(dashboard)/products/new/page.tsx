...
const translations = {
  ...
  save: { en: 'Save Product', fr: 'Enregistrer le produit', ht: 'Anrejistre pwodui', es: 'Guardar producto' },
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">{t('addProduct', translations.addProduct)}</h1>
      </div>
